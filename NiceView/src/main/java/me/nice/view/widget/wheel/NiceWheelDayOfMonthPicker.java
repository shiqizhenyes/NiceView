...
import static me.nice.view.helper.DateHelper.getDay;
import static me.nice.view.helper.DateHelper.today;


public class NiceWheelDayOfMonthPicker {

//    private int daysInMonth;
//    private DayOfMonthSelectedListener listener;
//    private FinishedLoopListener finishedLoopListener;
//
//    public NiceWheelDayOfMonthPicker(Context context) {
//        this(context, null);
//    }
//
//    public NiceWheelDayOfMonthPicker(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
//    @Override
...
//        void onFinishedLoop(NiceWheelDayOfMonthPicker picker);
//    }
//
//    public interface DayOfMonthSelectedListener {
//        void onDayOfMonthSelected(NiceWheelDayOfMonthPicker picker, int dayIndex);
//    }
}